...
const PostClient = () => {
  return (
    <main className="flex-1 min-h-screen bg-dark-30 rounded-xl">
      <section>
        ...
        {/* post info */}
        <section className="md:p-4 p-2 w-full flex flex-col gap-1.5">
          ...
          <div className="text-secondary-30">
            ...
            <p className="mb-4">
              In this app, you can submit a request for a certain product or service online and one of our agents will contact you back with
              an offer. You can also pay merchants directly through the app. After successfully any transaction you can see details about
              your payment. History details include: -Transaction ID.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              Time. What will you get? - 200+ Beautiful Screens design - Figma, XD & Sketch Files 100% editable and scalable. Thank You For
              Your Time.
            </p>
          </div>
