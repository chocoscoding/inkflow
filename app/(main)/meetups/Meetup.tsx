...
const Meetup: FC<OneMeetupType> = (props) => {
  const { id, title, body, coverImage, time, date, tags } = props;
  return (
       ...
       shrink-0 object-cover">
        ...
        <span className="flex w-full gap-1">
          <section className="w-full">
            ...
            <p className=" text-xs text-secondary-30 md:text-sm">🌍REMOTE</p>
          ...
          <div className="rounded-md flex flex-col items-center h-[4.3rem] lg1:h-[4rem] px-2 shadow-md dark:shadow-dark-10 shrink-0 ml-2">
            <p className="mt-2">{formatDateForMeetups(date).month}</p>
