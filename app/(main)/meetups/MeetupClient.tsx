  ...
  return (
    <div>
      <div className=" w-full flex flex-wrap gap-4">
        <section className="sticky top-[60px] rounded-xl bg-dark-40 w-3/12 max-w-[300px] p-4 h-fit">
        ...
        <Meetups />
        <section className="sticky top-[60px]  rounded-xl bg-[#FF7C4D] w-4/12 max-w-[310px] p-4 h-[180px]">
